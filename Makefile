windows:
	gcc -I include -L lib -o NotePlus src/main.c src/window/windowManager.c src/input/input.c src/noteio/noteio.c src\appdetect\appdetect.c -lmingw32 -lSDL2main -lSDL2 -lopengl32 -lglew32 -lSDL2_ttf
